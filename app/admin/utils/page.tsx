		...
		try {
			...
			if (response.ok) {
				...
				setResult({
					success: false,
					message:
						data.error || "Failed to delete attendance records",
				});
				setConfirmDelete(false);
			}
		} catch (error: any) {
		...
		<DashboardLayout role='admin'>
			<div className='p-4 md:p-6'>
				<div className='max-w-4xl mx-auto'>
					<h1 className='text-2xl font-bold text-gray-800 mb-6 font-primary'>
						Admin Utilities
					</h1>
						...
						<div className='flex items-start gap-4'>
							...
							<div className='flex-1'>
								...
								<p className='text-gray-600 mb-4 font-secondary'>
									This will permanently delete ALL attendance
									records for all users. This action cannot be
									undone.
								</p>
