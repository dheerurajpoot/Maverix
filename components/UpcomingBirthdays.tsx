				...
				<div className='flex items-center gap-2'>
					...
					<div>
						...
						<p className='text-[9px] text-gray-500 font-secondary mt-0.5'>
							{displayedCount}{" "}
							{displayedCount === 1 ? "birthday" : "birthdays"} •{" "}
							{displayMonthName}
						</p>
					</div>
				</div>
						...
						{filterType === "all" ? (
										...
										return (
											<div
												...
												<div className='flex items-center gap-2 px-4 py-3'>
													...
													<h3 className='text-sm font-bold text-gray-900 font-primary'>
														{getMonthName(month)}
													</h3>
													<span className='text-[8px] text-pink-500 font-secondary ml-auto border border-pink-500 rounded-full px-1 py-0.5'>
																...
																<motion.div
																	...
																	<div className='flex items-center gap-3'>
																		...
																		<div className='flex-shrink-0'>
																			<span
																				className={`px-2 py-1 rounded-full text-[10px] font-bold font-secondary whitespace-nowrap ${
																					isTodayBirthday
																						? "bg-pink-500 text-white"
																						: employee.daysUntil ===
																							  1
							...
							<div className='bg-pink-50 rounded-lg overflow-hidden'>
								...
								<div className='flex items-center gap-2 px-4 py-3'>
									...
									<span className='text-[8px] text-pink-500 font-secondary ml-auto border border-pink-500 rounded-full px-1 py-0.5'>
										{currentMonthBirthdays.length} Birthdays
									</span>
								</div>

								<div className='px-2 pb-2 space-y-1'>
									{currentMonthBirthdays.map(
										(employee, index) => {
											const isTodayBirthday =
