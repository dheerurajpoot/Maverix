						...
						<div className='flex items-center justify-between flex-shrink-0 p-3 border-b border-gray-200 bg-white'>
							<div className='flex items-center gap-2'>
								...
								<div className='flex-1 min-w-0'>
									<h2 className='text-sm font-primary font-bold text-gray-900 truncate'>
										{team.name}
									</h2>
									{team.description && (
										<p className='text-[9px] text-gray-500 font-secondary mt-0.5 truncate'>
											{team.description}
										</p>
									)}
								</div>
								...
								<div className='space-y-2.5 bg-white/40 backdrop-blur-sm rounded-xl p-3.5 border border-white/30'>
									...
									{selectedTeamName && (
										<div className='flex items-center gap-2.5 py-1.5'>
											...
											<div className='flex-1 min-w-0'>
												<p className='text-[10px] text-gray-500 font-secondary mb-0.5'>
													Team
												</p>
