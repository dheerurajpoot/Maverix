...
import { Calendar, Users, TrendingUp, Megaphone } from "lucide-react";
						...
						<div className='flex items-center gap-2'>
							{showAnnouncementButton && (
								<motion.button
									...
									<Megaphone
										className={`w-4 h-4 relative z-10 ${hasNewAnnouncement ? "animate-pulse" : ""}`}
									/>
