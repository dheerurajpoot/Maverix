...
export default function UpdateExitProcessModal({
	...
	const handleFileChange = (
		type: "experienceLetter" | "relievingLetter",
		file: File | null,
	) => {
		if (file) {
		...
		try {
			...
			if (step === "documents") {
				...
				if (files.experienceLetter) {
					...
					uploadedFiles.experienceLetter = await uploadFile(
				...
				if (files.relievingLetter) {
					...
					uploadedFiles.relievingLetter = await uploadFile(
									...
									<div>
										...
										<div className='flex items-center gap-2'>
											...
											<span className='text-sm text-gray-600'>
												Notice period has been complied
												with
											</span>
										</div>
									</div>
								...
								<>
									<div>
										...
										<div className='flex items-center gap-2'>
											...
											/>
											<span className='text-sm text-gray-600'>
												Exit process has been formally
												closed
											</span>
										</div>
									</div>
