...
import { Calendar, X, BarChart3, CheckCircle2 } from "lucide-react";
...
export default function AnnouncementModal({
	...
	const [localAnnouncement, setLocalAnnouncement] =
	...
	const handleVote = async (optionIndex: number) => {
		...
		try {
			const res = await fetch(
				`/api/announcements/${announcement._id}/poll/vote`,
				{
					method: "POST",
	...
	const getTotalVotes = () => {
		...
		return localAnnouncement.poll.options.reduce(
						...
						<motion.div
							...
							<div className='flex-1 min-w-0'>
								...
								<div className='flex items-center gap-2 text-xs text-gray-500'>
									<span className='capitalize font-secondary'>
						...
						{localAnnouncement.poll && (
							<motion.div
								...
								<div className='flex items-center gap-2 mb-2'>
									...
									<h3 className='text-sm font-primary font-semibold text-gray-800'>
										Poll
									</h3>
								</div>
								...
								<div className='space-y-2'>
									{localAnnouncement.poll.options.map(
										(option, index) => {
											const voteCount =
												option.votes?.length || 0;
											const percentage =
												getVotePercentage(voteCount);
											const userVotedIndex =
												getUserVote();
											const userVoted =
												...
												<motion.button
													...
													<div className='flex items-center justify-between relative z-10'>
														<div className='flex items-center gap-2 flex-1 min-w-0'>
															...
															<span
																className={`text-sm font-secondary truncate ${
																	userVoted
