...
export default function AllottedLeavesList({
	leaves,
	employees,
	onRefresh,
	onEditEmployee,
	...
	const filteredGroupedLeaves = useMemo(() => {
		...
		Object.keys(groupedLeaves).forEach((userId) => {
			...
			const matchesEmployee =
				!filterEmployee || userId === filterEmployee;
			const matchesStatus =
				filterStatus === "all" ||
	...
	return (
		<div className='bg-white rounded-lg shadow-sm border border-gray-100'>
			<div className='p-4 border-b border-gray-200'>
				<h2 className='text-lg font-primary font-semibold text-gray-800 mb-4'>
					Allotted Leaves
				</h2>
								...
								<div className='flex items-center justify-between mb-3'>
									<div className='flex items-center gap-2.5'>
										<UserAvatar
											name={
												employee?.name ||
												firstLeave.userId?.name
											}
											image={
												(employee as any)
													?.profileImage ||
												(firstLeave.userId as any)
													?.profileImage
											}
											size='md'
										/>
					...
					deleteModal.leave ? (
						<div className='space-y-1'>
							<div>
								...
								{deleteModal.leave.userId?.name || "N/A"} (
								{deleteModal.leave.userId?.email || "N/A"})
							</div>
							<div>
							...
							<div>
								...
								{(() => {
									const leaveTypeName =
										typeof deleteModal.leave.leaveType ===
										"object"
									...
									if (
										isShortDayLeaveType &&
										deleteModal.leave.hours !== undefined
									) {
										return formatHoursMinutes(
											deleteModal.leave.hours,
											deleteModal.leave.minutes,
										);
									}
